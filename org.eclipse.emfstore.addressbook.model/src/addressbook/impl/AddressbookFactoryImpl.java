...
public class AddressbookFactoryImpl extends EFactoryImpl implements AddressbookFactory {
	...
	public static AddressbookFactory init() {
		try {
			AddressbookFactory theAddressbookFactory = (AddressbookFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.dd-eclipse.de/hackathon/emfstore/addressbook"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case AddressbookPackage.COMPANY: return createCompany();
